...
void borrarFiguras(){
    ...
    texto(0,80,"100"); texto(75,0,"100");
    texto(0,180,"200"); texto(175,0,"200");
    texto(0,280,"300"); texto(275,0,"300");
    texto(0,380,"400"); texto(375,0,"400");
    texto(0,480,"500"); texto(475,0,"500");
    texto(0,580,"600"); texto(575,0,"600");
    texto(0,680,"700"); texto(675,0,"700");
...
inline void _elip(float x_cen, float y_cen, float radio, float RADIO) {
   BeginPath(hDCMem);
   Arc(hDCMem, int(x_cen - RADIO), int(y_cen - radio),
               int(x_cen + RADIO), int(y_cen + radio),
               int(x_cen - RADIO), int(y_cen - radio),
...
void elipse_lleno(float x_cen, float y_cen, float radio, float RADIO) {
   HBRUSH hBrush = CreateSolidBrush(_color);
   HGDIOBJ orig = SelectObject(hDCMem, hBrush);
   _elip(x_cen, y_cen, radio, RADIO);
   FillPath(hDCMem);
   SelectObject(hDCMem, orig);
   DeleteObject(hBrush);
}
